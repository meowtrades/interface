          ...
          <div className="mt-20 rounded-xl overflow-hidden shadow-2xl border border-meow-paw/10 mx-auto max-w-4xl animate-float">
            ...
            <div className="p-6 bg-white">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {strategyCards.map((strategy, index) => <div key={index} className="rounded-lg p-6 glass-card hover:shadow-lg transition-all">
      ...
      <section className="py-20 px-6 bg-meow-whisker">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => <div key={index} className="p-6 rounded-xl glass-card">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-meow-cream to-meow-whisker">
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            }].map((step, index) => <div key={index} className="relative z-10 text-center">
      ...
      <section className="py-20 px-6 bg-meow-whisker">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => <div key={index} className="p-6 rounded-xl glass-card">
